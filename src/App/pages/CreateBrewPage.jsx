...
import logo from '/src/assets/img/logoSF.png'; // Asegúrate de que este logo sea blanco o claro para el fondo oscuro
...
export const CreateBrewPage = () => {
  ...
  const createBrew = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/brews/create_brew', submitData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      });
