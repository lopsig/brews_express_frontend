...
export const HeaderProvider = ({ onSearch }) => {
  const [sidebarVisible, setSidebarVisible] = useState(false);
  ...
  const menuItems = [
    { label: 'Mi Perfil', icon: 'pi pi-user', page: '/be/profile-provider' },
    { label: 'Agregar Cerveza', icon: 'pi pi-plus', page: '/be/create-brew' },
    { label: 'Estadísticas', icon: 'pi pi-chart-bar', page: '/be/orders-provider' },
  ];
