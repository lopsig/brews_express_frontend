...
//           color: 'white',
//           padding: window.innerWidth < 768 ? '40px 30px' : '60px 40px',
//           display: 'flex',
//           flexDirection: 'column',
//           alignItems: 'center',
//           justifyContent: 'center',
//           textAlign: 'center',
//           minHeight: window.innerWidth < 768 ? '200px' : '600px'
//         }}>
//           {/* Logo */}
...
//                   fontSize: '0.9rem'
//                 }}>
//                   <i className={feature.icon} style={{ fontSize: '1.2rem', color: '#10B981' }}></i>
//                   {feature.text}
//                 </div>
//               ))}
//             </div>
...
//           flex: window.innerWidth < 768 ? 'none' : '1',
//           width: window.innerWidth < 768 ? '100%' : '50%',
//           padding: window.innerWidth < 768 ? '30px' : '60px 50px',
//           display: 'flex',
//           flexDirection: 'column',
//           justifyContent: 'center'
//         }}>
